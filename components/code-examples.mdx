...
title: Code Examples
description: >-
  Showcase code with syntax highlighting, multiple language support, and
  interactive features using Documentation.AI's code components for ACME Company
  APIs.
---
...
<CodeGroup uid="9454d099-68d0-4b60-8f3a-c1e459ec5ede" show-lines="true" tabs={[]}>
  ```javascript
...
<CodeGroup uid="00c493e1-b35c-4346-b35c-3d24e8239f4f" show-lines="true" tabs={[]}>
  ```typescript
...
<CodeGroup uid="8dbc6544-6044-41fa-8f97-4edc364bbe55" show-lines="true" tabs={[]}>
  ```javascript
...
<CodeGroup uid="55353766-0ca4-4d04-bb30-742771268de8" show-lines="true" tabs={[]}>
  ```javascript
...
<Callout uid="c3f2d590-a36b-4784-bd34-59f51c7b5f06" kind="tip" collapsed="false">
